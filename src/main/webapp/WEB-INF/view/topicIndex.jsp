...
<%@ include file="header.jsp" %>
	...
	<div class="main w clearfix">
		<div class="main-left">
			<div class="share">
				<div class="share-left"><span></span>&nbsp;话题</div>
				...
				<div class="post-wrap">
                    ...
                    <nav class="col-md-10 col-md-offset-2">
                        <ul class="pagination pagination-sm">
                            <%--首页--%>
                            <li><a href="listPostByTimeAndTopic.do?curPage=1&tid=${tid}">首页</a></li>
                            <%--上一页--%>
                            <c:choose>
                                <c:when test="${pageBean.curPage!=1 }">
                                    <li><a href="listPostByTimeAndTopic.do?curPage=${pageBean.curPage-1 }&tid=${tid}"><span>&laquo;</span></a></li>
                                </c:when>
                                <c:otherwise>
                            ...
                            <c:choose>
                                <c:when test="${pageBean.allPage<=10 }">
                                    <c:forEach begin="1" end="${ pageBean.allPage}" var="i">
                                        <li class="pageNum"><a href="listPostByTimeAndTopic.do?curPage=${i }&tid=${tid}">${i }</a></li>
                                    </c:forEach>
                                </c:when>
                            ...
                            <c:choose>
                                <c:when test="${pageBean.curPage!=pageBean.allPage }">
                                    <li><a href="listPostByTimeAndTopic.do?curPage=${pageBean.curPage+1 }&tid=${tid}"><span>&raquo;</span></a></li>
                                </c:when>
                                <c:otherwise>
                            ...
                            <%--尾页--%>
                            <li><a href="listPostByTimeAndTopic.do?curPage=${pageBean.allPage}&tid=${tid}">尾页</a></li>
                        </ul>
                    </nav>
